...
# The highest total stats (excluding hp related ones) at highest level = strongest

select poke.name 'Pokemon Name', t.trainername 'Trainer Name', pt.pokelevel Level,
       prime_type.name 'Primary Type', second_type.name "Secondary Type", pt.attack+pt.defense+pt.defense+pt.spatk+pt.spdef+pt.speed as Stat_Total
